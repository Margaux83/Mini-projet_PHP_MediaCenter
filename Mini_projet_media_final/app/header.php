...
<nav class="navbar navbar-expand navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <a href="commentaires.php" class="nav-item active nav-link">Commentaires</a>
      ...
      <a href="traitement/deco.php" class="nav item active nav-link">Déconnexion</a>
                ...
                <a href="admin/membre2.php" class="nav item active nav-link">Panel Admin</a> /
